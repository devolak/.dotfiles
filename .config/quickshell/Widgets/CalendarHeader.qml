...
Item {
  ...
  Rectangle {
    ...
    height: 36
    radius: 18
    color: monthYearMouse.containsMouse ? Color.moduleBackground : "transparent"
  ...
  Row {
    ...
    Rectangle {
      ...
      height: 36
      radius: 18
      color: todayMouse.containsMouse ? Color.moduleBackground : "transparent"
    ...
    Rectangle {
      ...
      height: 36
      radius: 18
      color: prevMouse.containsMouse ? Color.moduleBackground : "transparent"
    ...
    Rectangle {
      ...
      height: 36
      radius: 18
      color: nextMouse.containsMouse ? Color.moduleBackground : "transparent"
